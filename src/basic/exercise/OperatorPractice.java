...
public class OperatorPractice {
	...
	public static void main(String[] args) {
		...
		// result1 = (int)result1;		
		// System.out.println(result1);
		// int로 강제 형 변환은 되었으나 result1은 위에서 double로 선언했었다.
		// 그래서 소수점 30.5에서 0.5가 잘리긴 했으나
		// double 형이라 30.0으로 나온다.
		// 그래서 정수형으로 출력하고 싶다면 출력에 (int) 삽입하면 된다.
		...
		System.out.println("50보다 큰가? : " + result3);
